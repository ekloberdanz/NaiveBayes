...
vocabularyDirectory = sys.argv[5]
with open(vocabularyDirectory, "r") as f:
...
#Import train label 
trainLabelDirectory = sys.argv[1]
with open(trainLabelDirectory) as csvfile:
...
# Import train data
trainDataDirectory = sys.argv[2]
with open(trainDataDirectory) as csvfile:
    readCSV = csv.reader(csvfile, delimiter=",")
    X_train = []
    for item in readCSV:
...
# Import test data
testDataDirectory = sys.argv[4]
with open(testDataDirectory) as csvfile:
    readCSV = csv.reader(csvfile, delimiter=",")
    X_test = []
    for item in readCSV:
...
#Import test label 
testLabelDirectory = sys.argv[3]
with open(testLabelDirectory) as csvfile:
    readCSV = csv.reader(csvfile, delimiter=",")
    y_test = []
    document_ID = 1
    for category in readCSV:
